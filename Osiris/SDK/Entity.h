...
public:
    ...
    Vector& GetMins()
    {
        static unsigned int m_vecMins = DataMap::findInDataMap(getPredDescMap(), "m_vecMins");
        return *reinterpret_cast<Vector*>(reinterpret_cast<uintptr_t>(this) + m_vecMins);
    }
    
    Vector& GetMaxs()
    {
        static unsigned int m_vecMaxs = DataMap::findInDataMap(getPredDescMap(), "m_vecMaxs");
        return *reinterpret_cast<Vector*>(reinterpret_cast<uintptr_t>(this) + m_vecMaxs);
    }
    ...
    NETVAR(getRotation, "CBaseEntity", "m_angRotation", Vector)
